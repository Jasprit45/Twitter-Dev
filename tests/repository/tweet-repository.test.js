...
describe ('Create tweet tests',() => {
    test('should create a new tweet and return it',async ()=> {
        ...
        const spy = jest.spyOn(Tweet, 'create').mockImplementation(()=>{
            return {...data,createdAt: '2026-02-12' , updatedAt: '2026-02-12'}
        });
    ...
    test('should not create a new tweet and throw exception',async ()=> {
        ...
        const tweet = await tweetRepository.create(data).catch(err => {
            ...
            expect(err.message).toBw('something went wrong');
        });
...
describe('Get all tweet tests',()=> {
    test('testing limit for get all',async ()=> {
        ...
        const tweetsArray =[{...data,createdAt: '2026-02-12' , updatedAt: '2026-02-12'},{...data,createdAt: '2026-02-12' , updatedAt: '2026-02-12'},{...data,createdAt: '2026-02-12' , updatedAt: '2026-02-12'}]
